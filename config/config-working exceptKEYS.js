	...
	
{
  ...
  config: {
    enableKeyboard: true, // allows normal keyboard keys
    enableKeypad: false, // disable number pad
    enableJoystick: false, // disable game controllers
    evdev: null // prevent it from trying /dev/input/btremote
  },
      ...
      config: {
        timings: {
	     ...
	     modules: [
                ...
                ["kyle-cal", "compliments", "cal-fireparie","clock-analog"], // page 1
		["adrian-cal", "compliments", "cal-middle","clock-analog"], // page 2
