...
let config = {
  ...
  module: 'MMM-pages',
  config: {
    rotationTime: 15000, // <- auto-rotate every 15 seconds
    animationTime: 1000,
    modules: [
      ["clock-analog","day-family","cal-family","compliments","weather","remote"],   // page 0
	...
	
{
  ...
  apiKey: "1979198420122014iameverything"   // optional but recommended
},
